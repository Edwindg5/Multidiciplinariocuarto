...
export const routes: Routes = [
  ...
  { path: 'componentes-electronicos', component: ComponentesElectronicosComponent, canActivate: [AuthGuard] },
  { path: 'todos-los-productos', component: TodosLosProductosComponent, canActivate: [AuthGuard] },
